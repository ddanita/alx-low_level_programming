...
/**
 * print_class - print class of the ELF headers.
 * @e_ident: Points to arrays containing ELF class.
 */
 ...
 * @e_ident: Points to arrays containing the ELF version.
 */
 ...
 * @e_ident: points to the array containing ELF version.
 */
 ...
 * @e_ident: points to arrays containing ELF ABI version.
 */
 ...
 * @argc: Number of arguments supplied to the programs.
