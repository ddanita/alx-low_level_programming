...
/**
 * create_buffer - will allocate 1024 bytes for buffers.
 * @file: it's the name of file buffer for storing the char
 ...
 * @argc: is the number of arguments supplied to Program
